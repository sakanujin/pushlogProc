...
import gph   # graph manipulate


####################  setting values ##################
file_path = "C:\\Users\\Sakashita\\sakawork\\Scarpe_Pushlog\\report\\sample6.xlsx"
...
wb = excel_app.Workbooks.Open("C:\\Users\\Sakashita\\sakawork\\Scarpe_Pushlog\\report\\sample6.xlsx")
...
################## graph manupulate proc ##################
fpath = "C:\\Users\\Sakashita\\sakawork\\Scarpe_Pushlog\\report\\sample6.xlsx"
gph_sheet = 'G'
data_sheet = 'D'
drange =  "U$2:U$1443"
gname = "Chart 2"

gph.change_series_formula(fpath, gph_sheet, data_sheet, drange, gname, 1)
...
#receiver_email = 'sakaguchi@kannetsu.co.jp'
